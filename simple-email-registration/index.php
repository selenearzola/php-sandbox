<?php
	...
	if( $_SERVER['REQUEST_METHOD'] == 'POST'){
		// trim: it helps to trim extra spaces, in this case that
		// the user can insert while he/she is typing into the 
		// input text.
		// 
		...
		// We have to make sure that the user fill everything
		// okay.
		// 
