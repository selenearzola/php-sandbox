<?php
	...
	// We're not allow to acess to the cookie
	// value right away, until we reload the 
	//  page.
	

	// 3.- Delete a cookie, you have to set the time
	// in the past for do it, e.g.
	// 
	  
	//setcookie('fontSize', 25, time() - 60 * 30);
	//setcookie('fontColor', 25, time() - 60 * 30);

	// 4.- Fourth parameter if you want your
	//  cookie to be avaible on your entire 
	//  site you use '/' , but if you want it for
	//  an specific section e.g '/admin' .
	//  
