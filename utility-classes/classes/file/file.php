<?php
	...
	class File {
		...
		public static function get($file,$default){
			...
			return static::exists($file,$default)
		...
		if( $append){
			// The FILE_APPEND it's a param flag to specify if the user choose
			// to append the "new" inserted text into the file that 
			// already exists.
		...
		// This a function to append "new added text" directly into a file
		//  without using a flag like we did un the put method.
