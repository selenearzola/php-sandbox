<?php
	...
	*/
	...
	// FILE EXISTS:
	// echo File::exists('my-file.txt')? 'it does':'NOT';
	...
	// PHP_ENO: Meas PHP_EndOfLine
	// FILE: WRITE an append content, we use a flag
	// for it.	
	//echo File::put('my-file.txt',",i'm from Mexico.".PHP_EOL,true);
	
	// FILE:APPEND we append a new text added directly, without using 
	// a flag like we did in put function. 
